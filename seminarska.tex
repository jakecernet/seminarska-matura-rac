...
Na slovenskem trgu obstaja več delnih rešitev. Uradna aplikacija LPP Ljubljana \cite{lppapp} pokriva izključno mestne avtobuse v Ljubljani. Spletni portal BrezAvta \cite{ijppweb} nudi načrtovanje poti od točke do točke za medkrajevne avtobuse, ni pa primeren za spremljanje trenutnih pozicij avtobusov. Portal SŽ \cite{szweb} omogoča vpogled v red vožnje, ne prikazuje pa položajev vlakov na zemljevidu.
...
Osnova za kartografski prikaz je knjižnica MapLibre GL JS \cite{maplibre}, odprtokodna nadgradnja projekta Mapbox GL JS. Knjižnica za upodabljanje zemljevida uporablja tehnologijo WebGL, kar zagotavlja tekoče gibanje in visoko zmogljivost celo pri prikazu tisočih točk hkrati. Zemljevida sta dva: svetel (OpenStreetMap Raster Light) in temen (OpenStreetMap Raster Dark), med njima pa lahko preklopi uporabnik. Na sliki 2 je prikazan svetli zemljevid z izrisanimi položaji avtobusov in postajališč.
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{img/routa.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{img/postaje.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{img/linije.png}
